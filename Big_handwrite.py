...
tf.app.flags.DEFINE_integer('max_steps', 9000, 'the max training steps ')
...
tf.app.flags.DEFINE_string('train_data_dir', 'C:/Users/Administrator/PycharmProjects/TensorflowCode/data/train', 'the train dataset dir')
tf.app.flags.DEFINE_string('test_data_dir', 'C:/Users/Administrator/PycharmProjects/TensorflowCode/data/test', 'the test dataset dir')
...
def eval_metric(final_predict_index, groundtruth):
    ...
    for index, val in enumerate(groundtruth):
        print
        'val {0}, final_predict_index {1}'.format(val, final_predict_index[index])
...
def run():
    ...
    if FLAGS.mode == "train":
        ...
        logger.info('the result info label {0} predict index {1} predict_val {2}'.format(1066, final_predict_index,
                                                                                         final_predict_val))
