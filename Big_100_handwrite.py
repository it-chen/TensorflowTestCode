...
def run():
    ...
    if FLAGS.mode == "train":
        ...
        image_file = 'C:\\Users\\Administrator\\PycharmProjects\\TensorflowCode\\data\\test\\00003\\58293.png'
        final_predict_val, final_predict_index = inference(image_file)
        logger.info('the result info label {0} predict index {1} predict_val {2}'.format(3, final_predict_index,
                                                                                         final_predict_val))
